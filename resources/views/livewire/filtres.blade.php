                    ...
                    <div class="w-full sm:max-w-xs inline-flex">
                        ...
                        <div class="relative">
                            <input id="search" name="search"
                                class="w-full rounded-md border border-gray-300 bg-white py-2 pl-5 pr-3 text-sm placeholder-gray-500 focus:border-indigo-500 focus:text-gray-900 focus:placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm"
                                placeholder="Recherche" type="search">
                        </div>
                        <button wire:click="getSearchInput('{{Request::input('search')}}')" type="button submit" class="ml-5 inline-flex items-center rounded-full border border-transparent bg-indigo-600 px-2.5 py-1.5 text-xs font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">                                

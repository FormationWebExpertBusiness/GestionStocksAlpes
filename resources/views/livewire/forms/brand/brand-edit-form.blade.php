<div>
    <button wire:click="toggleEditForm" class="inline-flex items-center rounded-md border border-transparent bg-white p-3 text-indigo-600 shadow hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">

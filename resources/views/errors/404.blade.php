...
<head>
    @include('default')
    <title>Alpes - 404</title>
</head>

<body class="h-screen overflow-hidden flex min-w-full items-center justify-center" style="background: #edf2f7;">
    <div class="flex items-center justify-center min-w-full min-h-screen bg-indigo-500  bg-fixed bg-cover bg-bottom error-bg"
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
                    ...
                    <p class="text-gray-100 mt-2 mb-6">Vous vous êtes perdu ❔</p>
                    <a href="/stock"

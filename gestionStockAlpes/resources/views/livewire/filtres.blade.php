<div>
    <header class="bg-white shadow">
        <div class="mx-auto max-w-7xl px-2 sm:px-4 lg:divide-y lg:divide-gray-200 lg:px-8">
            ...
            <nav class="hidden min-w-full content-center justify-items-center justify-center lg:flex items-center lg:py-2" aria-label="Global">
                <div class="relative inline-block text-left">
                    <div>
                        <button wire:click="toggleDropdown" type="button" class="inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100" id="menu-button" aria-expanded="true" aria-haspopup="true">
                            Filtres
                            @if(!$isVisible)
                    ...
                    @if($isVisible)
                        ...
                        <div class="py-1" role="none">
                            <a href="#" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">Categorie</a>
                            <a href="#" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-1">Marque</a>
                        </div>
                        </div>
                    @endif
                </div>

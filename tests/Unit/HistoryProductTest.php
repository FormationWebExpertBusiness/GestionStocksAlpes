...
test('test HistoryProduct method oldestDate', function () {  
    DB::table('history_products')->insert(['code_action' => 'C', 'category' => 'cat', 'brand' => 'bra', 'model' => 'mod' ,'price' => 5, 'serial_number' => 'ite', 'user_id' => 1, 
...
test('test HistoryProduct method getAllBrands', function () {  
    ...
    DB::table('history_products')->insert(['code_action' => 'C', 'category' => 'cat', 'brand' => 'bra2', 'model' => 'mod' ,'price' => 5, 'serial_number' => 'ite', 'user_id' => 1,
        'created_at' => Carbon::now()->format('Y-m-d H:i:s')
    ]);
    DB::table('history_products')->insert(['code_action' => 'C', 'category' => 'cat', 'brand' => 'bra', 'model' => 'mod' ,'price' => 5, 'serial_number' => 'ite', 'user_id' => 1,
        'created_at' => Carbon::yesterday()->format('Y-m-d H:i:s')
...
test('test HistoryProduct method getAllCategories', function () {  
    ...
    DB::table('history_products')->insert(['code_action' => 'C', 'category' => 'cat2', 'brand' => 'bra2', 'model' => 'mod' ,'price' => 5, 'serial_number' => 'ite', 'user_id' => 1,
        'created_at' => Carbon::now()->format('Y-m-d H:i:s')
    ]);
    DB::table('history_products')->insert(['code_action' => 'C', 'category' => 'cat', 'brand' => 'bra', 'model' => 'mod' ,'price' => 5, 'serial_number' => 'ite', 'user_id' => 1,
        'created_at' => Carbon::yesterday()->format('Y-m-d H:i:s')
